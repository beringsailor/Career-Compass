...
def get_all_codes():
    ...
    while True:
        try:
            ...
            logger.error("exception when crawling", e)
...
def insert_sql(all_jd_list):
    ...
    try:
        ...
        db_mysql_conn.commit()
        print("temp_jobcat table inserted")
        ...
        if result['cnt'] == 0:
            ...
            return
        print("temp_job table is not empty")
        ...
        print("job removed deleted and updated")
